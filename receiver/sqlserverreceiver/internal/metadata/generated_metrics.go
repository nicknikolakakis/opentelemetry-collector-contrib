...
type metricSqlserverBatchRequestRate struct {
	...
	config   SqlserverBatchRequestRateConfig // metric config provided by user.
...
func newMetricSqlserverBatchRequestRate(cfg SqlserverBatchRequestRateConfig) metricSqlserverBatchRequestRate {
...
type metricSqlserverBatchSQLCompilationRate struct {
	data     pmetric.Metric                         // data buffer for generated metric.
	config   SqlserverBatchSQLCompilationRateConfig // metric config provided by user.
	capacity int                                    // max observed number of data points added to the metric.
}
...
func newMetricSqlserverBatchSQLCompilationRate(cfg SqlserverBatchSQLCompilationRateConfig) metricSqlserverBatchSQLCompilationRate {
...
type metricSqlserverBatchSQLRecompilationRate struct {
	data     pmetric.Metric                           // data buffer for generated metric.
	config   SqlserverBatchSQLRecompilationRateConfig // metric config provided by user.
	capacity int                                      // max observed number of data points added to the metric.
}
...
func newMetricSqlserverBatchSQLRecompilationRate(cfg SqlserverBatchSQLRecompilationRateConfig) metricSqlserverBatchSQLRecompilationRate {
...
type metricSqlserverComputerUptime struct {
	data     pmetric.Metric                // data buffer for generated metric.
	config   SqlserverComputerUptimeConfig // metric config provided by user.
	capacity int                           // max observed number of data points added to the metric.
}
...
func newMetricSqlserverComputerUptime(cfg SqlserverComputerUptimeConfig) metricSqlserverComputerUptime {
...
type metricSqlserverCPUCount struct {
	data     pmetric.Metric          // data buffer for generated metric.
	config   SqlserverCPUCountConfig // metric config provided by user.
	capacity int                     // max observed number of data points added to the metric.
}
...
func newMetricSqlserverCPUCount(cfg SqlserverCPUCountConfig) metricSqlserverCPUCount {
...
type metricSqlserverDatabaseBackupOrRestoreRate struct {
	data     pmetric.Metric                             // data buffer for generated metric.
	config   SqlserverDatabaseBackupOrRestoreRateConfig // metric config provided by user.
	capacity int                                        // max observed number of data points added to the metric.
}
...
func newMetricSqlserverDatabaseBackupOrRestoreRate(cfg SqlserverDatabaseBackupOrRestoreRateConfig) metricSqlserverDatabaseBackupOrRestoreRate {
...
type metricSqlserverDatabaseCount struct {
	data          pmetric.Metric               // data buffer for generated metric.
	config        SqlserverDatabaseCountConfig // metric config provided by user.
	capacity      int                          // max observed number of data points added to the metric.
...
func (m *metricSqlserverDatabaseCount) recordDataPoint(start pcommon.Timestamp, ts pcommon.Timestamp, val int64, databaseStatusAttributeValue string) {
	...
	dp.SetStartTimestamp(start)
	dp.SetTimestamp(ts)
	if slices.Contains(m.config.EnabledAttributes, SqlserverDatabaseCountAttributeKeyDatabaseStatus) {
...
func newMetricSqlserverDatabaseCount(cfg SqlserverDatabaseCountConfig) metricSqlserverDatabaseCount {
...
type metricSqlserverDatabaseExecutionErrors struct {
	data     pmetric.Metric                         // data buffer for generated metric.
	config   SqlserverDatabaseExecutionErrorsConfig // metric config provided by user.
	capacity int                                    // max observed number of data points added to the metric.
}
...
func newMetricSqlserverDatabaseExecutionErrors(cfg SqlserverDatabaseExecutionErrorsConfig) metricSqlserverDatabaseExecutionErrors {
...
type metricSqlserverDatabaseFullScanRate struct {
	data     pmetric.Metric                      // data buffer for generated metric.
	config   SqlserverDatabaseFullScanRateConfig // metric config provided by user.
	capacity int                                 // max observed number of data points added to the metric.
}
...
func newMetricSqlserverDatabaseFullScanRate(cfg SqlserverDatabaseFullScanRateConfig) metricSqlserverDatabaseFullScanRate {
...
type metricSqlserverDatabaseIo struct {
	data          pmetric.Metric            // data buffer for generated metric.
	config        SqlserverDatabaseIoConfig // metric config provided by user.
	capacity      int                       // max observed number of data points added to the metric.
	aggDataPoints []int64                   // slice containing number of aggregated datapoints at each index
}
...
func (m *metricSqlserverDatabaseIo) recordDataPoint(start pcommon.Timestamp, ts pcommon.Timestamp, val int64, physicalFilenameAttributeValue string, logicalFilenameAttributeValue string, fileTypeAttributeValue string, directionAttributeValue string) {
	...
	dp.SetStartTimestamp(start)
	dp.SetTimestamp(ts)
	if slices.Contains(m.config.EnabledAttributes, SqlserverDatabaseIoAttributeKeyPhysicalFilename) {
		dp.Attributes().PutStr("physical_filename", physicalFilenameAttributeValue)
	}
	if slices.Contains(m.config.EnabledAttributes, SqlserverDatabaseIoAttributeKeyLogicalFilename) {
		dp.Attributes().PutStr("logical_filename", logicalFilenameAttributeValue)
	}
	if slices.Contains(m.config.EnabledAttributes, SqlserverDatabaseIoAttributeKeyFileType) {
		dp.Attributes().PutStr("file_type", fileTypeAttributeValue)
	}
	if slices.Contains(m.config.EnabledAttributes, SqlserverDatabaseIoAttributeKeyDirection) {
...
func newMetricSqlserverDatabaseIo(cfg SqlserverDatabaseIoConfig) metricSqlserverDatabaseIo {
...
type metricSqlserverDatabaseLatency struct {
	data          pmetric.Metric                 // data buffer for generated metric.
	config        SqlserverDatabaseLatencyConfig // metric config provided by user.
	capacity      int                            // max observed number of data points added to the metric.
...
func (m *metricSqlserverDatabaseLatency) recordDataPoint(start pcommon.Timestamp, ts pcommon.Timestamp, val float64, physicalFilenameAttributeValue string, logicalFilenameAttributeValue string, fileTypeAttributeValue string, directionAttributeValue string) {
	...
	dp.SetStartTimestamp(start)
	dp.SetTimestamp(ts)
	if slices.Contains(m.config.EnabledAttributes, SqlserverDatabaseLatencyAttributeKeyPhysicalFilename) {
		dp.Attributes().PutStr("physical_filename", physicalFilenameAttributeValue)
	}
	if slices.Contains(m.config.EnabledAttributes, SqlserverDatabaseLatencyAttributeKeyLogicalFilename) {
		dp.Attributes().PutStr("logical_filename", logicalFilenameAttributeValue)
	}
	if slices.Contains(m.config.EnabledAttributes, SqlserverDatabaseLatencyAttributeKeyFileType) {
		dp.Attributes().PutStr("file_type", fileTypeAttributeValue)
	}
	if slices.Contains(m.config.EnabledAttributes, SqlserverDatabaseLatencyAttributeKeyDirection) {
		dp.Attributes().PutStr("direction", directionAttributeValue)
	}
...
func newMetricSqlserverDatabaseLatency(cfg SqlserverDatabaseLatencyConfig) metricSqlserverDatabaseLatency {
...
type metricSqlserverDatabaseOperations struct {
	data          pmetric.Metric                    // data buffer for generated metric.
	config        SqlserverDatabaseOperationsConfig // metric config provided by user.
	capacity      int                               // max observed number of data points added to the metric.
	aggDataPoints []int64                           // slice containing number of aggregated datapoints at each index
}
...
func (m *metricSqlserverDatabaseOperations) recordDataPoint(start pcommon.Timestamp, ts pcommon.Timestamp, val int64, physicalFilenameAttributeValue string, logicalFilenameAttributeValue string, fileTypeAttributeValue string, directionAttributeValue string) {
	...
	dp.SetStartTimestamp(start)
	dp.SetTimestamp(ts)
	if slices.Contains(m.config.EnabledAttributes, SqlserverDatabaseOperationsAttributeKeyPhysicalFilename) {
		dp.Attributes().PutStr("physical_filename", physicalFilenameAttributeValue)
	}
	if slices.Contains(m.config.EnabledAttributes, SqlserverDatabaseOperationsAttributeKeyLogicalFilename) {
		dp.Attributes().PutStr("logical_filename", logicalFilenameAttributeValue)
	}
	if slices.Contains(m.config.EnabledAttributes, SqlserverDatabaseOperationsAttributeKeyFileType) {
		dp.Attributes().PutStr("file_type", fileTypeAttributeValue)
	}
	if slices.Contains(m.config.EnabledAttributes, SqlserverDatabaseOperationsAttributeKeyDirection) {
		dp.Attributes().PutStr("direction", directionAttributeValue)
	}
...
func newMetricSqlserverDatabaseOperations(cfg SqlserverDatabaseOperationsConfig) metricSqlserverDatabaseOperations {
...
type metricSqlserverDatabaseTempdbSpace struct {
	data          pmetric.Metric                     // data buffer for generated metric.
	config        SqlserverDatabaseTempdbSpaceConfig // metric config provided by user.
	capacity      int                                // max observed number of data points added to the metric.
	aggDataPoints []int64                            // slice containing number of aggregated datapoints at each index
}
...
func (m *metricSqlserverDatabaseTempdbSpace) recordDataPoint(start pcommon.Timestamp, ts pcommon.Timestamp, val int64, tempdbStateAttributeValue string) {
	...
	dp.SetStartTimestamp(start)
	dp.SetTimestamp(ts)
	if slices.Contains(m.config.EnabledAttributes, SqlserverDatabaseTempdbSpaceAttributeKeyTempdbState) {
...
func newMetricSqlserverDatabaseTempdbSpace(cfg SqlserverDatabaseTempdbSpaceConfig) metricSqlserverDatabaseTempdbSpace {
...
type metricSqlserverDatabaseTempdbVersionStoreSize struct {
	data     pmetric.Metric                                // data buffer for generated metric.
	config   SqlserverDatabaseTempdbVersionStoreSizeConfig // metric config provided by user.
	capacity int                                           // max observed number of data points added to the metric.
}
...
func newMetricSqlserverDatabaseTempdbVersionStoreSize(cfg SqlserverDatabaseTempdbVersionStoreSizeConfig) metricSqlserverDatabaseTempdbVersionStoreSize {
...
type metricSqlserverDeadlockRate struct {
	data     pmetric.Metric              // data buffer for generated metric.
	config   SqlserverDeadlockRateConfig // metric config provided by user.
	capacity int                         // max observed number of data points added to the metric.
}
...
func newMetricSqlserverDeadlockRate(cfg SqlserverDeadlockRateConfig) metricSqlserverDeadlockRate {
...
type metricSqlserverIndexSearchRate struct {
	data     pmetric.Metric                 // data buffer for generated metric.
	config   SqlserverIndexSearchRateConfig // metric config provided by user.
	capacity int                            // max observed number of data points added to the metric.
}
...
func newMetricSqlserverIndexSearchRate(cfg SqlserverIndexSearchRateConfig) metricSqlserverIndexSearchRate {
...
type metricSqlserverLockTimeoutRate struct {
	data     pmetric.Metric                 // data buffer for generated metric.
	config   SqlserverLockTimeoutRateConfig // metric config provided by user.
	capacity int                            // max observed number of data points added to the metric.
}
...
func newMetricSqlserverLockTimeoutRate(cfg SqlserverLockTimeoutRateConfig) metricSqlserverLockTimeoutRate {
...
type metricSqlserverLockWaitCount struct {
	data     pmetric.Metric               // data buffer for generated metric.
	config   SqlserverLockWaitCountConfig // metric config provided by user.
	capacity int                          // max observed number of data points added to the metric.
}
...
func newMetricSqlserverLockWaitCount(cfg SqlserverLockWaitCountConfig) metricSqlserverLockWaitCount {
...
type metricSqlserverLockWaitRate struct {
	data     pmetric.Metric              // data buffer for generated metric.
	config   SqlserverLockWaitRateConfig // metric config provided by user.
	capacity int                         // max observed number of data points added to the metric.
}
...
func newMetricSqlserverLockWaitRate(cfg SqlserverLockWaitRateConfig) metricSqlserverLockWaitRate {
...
type metricSqlserverLockWaitTimeAvg struct {
	data     pmetric.Metric                 // data buffer for generated metric.
	config   SqlserverLockWaitTimeAvgConfig // metric config provided by user.
	capacity int                            // max observed number of data points added to the metric.
}
...
func newMetricSqlserverLockWaitTimeAvg(cfg SqlserverLockWaitTimeAvgConfig) metricSqlserverLockWaitTimeAvg {
...
type metricSqlserverLoginRate struct {
	data     pmetric.Metric           // data buffer for generated metric.
	config   SqlserverLoginRateConfig // metric config provided by user.
	capacity int                      // max observed number of data points added to the metric.
}
...
func newMetricSqlserverLoginRate(cfg SqlserverLoginRateConfig) metricSqlserverLoginRate {
...
type metricSqlserverLogoutRate struct {
	data     pmetric.Metric            // data buffer for generated metric.
	config   SqlserverLogoutRateConfig // metric config provided by user.
	capacity int                       // max observed number of data points added to the metric.
}
...
func newMetricSqlserverLogoutRate(cfg SqlserverLogoutRateConfig) metricSqlserverLogoutRate {
...
type metricSqlserverMemoryGrantsPendingCount struct {
	data     pmetric.Metric                          // data buffer for generated metric.
	config   SqlserverMemoryGrantsPendingCountConfig // metric config provided by user.
	capacity int                                     // max observed number of data points added to the metric.
}
...
func newMetricSqlserverMemoryGrantsPendingCount(cfg SqlserverMemoryGrantsPendingCountConfig) metricSqlserverMemoryGrantsPendingCount {
...
type metricSqlserverMemoryUsage struct {
	data     pmetric.Metric             // data buffer for generated metric.
	config   SqlserverMemoryUsageConfig // metric config provided by user.
	capacity int                        // max observed number of data points added to the metric.
}
...
func newMetricSqlserverMemoryUsage(cfg SqlserverMemoryUsageConfig) metricSqlserverMemoryUsage {
...
type metricSqlserverOsWaitDuration struct {
	data          pmetric.Metric                // data buffer for generated metric.
	config        SqlserverOsWaitDurationConfig // metric config provided by user.
	capacity      int                           // max observed number of data points added to the metric.
	aggDataPoints []float64                     // slice containing number of aggregated datapoints at each index
}
...
func (m *metricSqlserverOsWaitDuration) recordDataPoint(start pcommon.Timestamp, ts pcommon.Timestamp, val float64, waitCategoryAttributeValue string, waitTypeAttributeValue string) {
	...
	dp.SetStartTimestamp(start)
	dp.SetTimestamp(ts)
	if slices.Contains(m.config.EnabledAttributes, SqlserverOsWaitDurationAttributeKeyWaitCategory) {
		dp.Attributes().PutStr("wait.category", waitCategoryAttributeValue)
	}
	if slices.Contains(m.config.EnabledAttributes, SqlserverOsWaitDurationAttributeKeyWaitType) {
...
func newMetricSqlserverOsWaitDuration(cfg SqlserverOsWaitDurationConfig) metricSqlserverOsWaitDuration {
...
type metricSqlserverPageBufferCacheFreeListStallsRate struct {
	data     pmetric.Metric                                   // data buffer for generated metric.
	config   SqlserverPageBufferCacheFreeListStallsRateConfig // metric config provided by user.
	capacity int                                              // max observed number of data points added to the metric.
}
...
func newMetricSqlserverPageBufferCacheFreeListStallsRate(cfg SqlserverPageBufferCacheFreeListStallsRateConfig) metricSqlserverPageBufferCacheFreeListStallsRate {
...
type metricSqlserverPageBufferCacheHitRatio struct {
	data     pmetric.Metric                         // data buffer for generated metric.
	config   SqlserverPageBufferCacheHitRatioConfig // metric config provided by user.
	capacity int                                    // max observed number of data points added to the metric.
}
...
func newMetricSqlserverPageBufferCacheHitRatio(cfg SqlserverPageBufferCacheHitRatioConfig) metricSqlserverPageBufferCacheHitRatio {
...
type metricSqlserverPageCheckpointFlushRate struct {
	data     pmetric.Metric                         // data buffer for generated metric.
	config   SqlserverPageCheckpointFlushRateConfig // metric config provided by user.
	capacity int                                    // max observed number of data points added to the metric.
}
...
func newMetricSqlserverPageCheckpointFlushRate(cfg SqlserverPageCheckpointFlushRateConfig) metricSqlserverPageCheckpointFlushRate {
...
type metricSqlserverPageLazyWriteRate struct {
	data     pmetric.Metric                   // data buffer for generated metric.
	config   SqlserverPageLazyWriteRateConfig // metric config provided by user.
	capacity int                              // max observed number of data points added to the metric.
}
...
func newMetricSqlserverPageLazyWriteRate(cfg SqlserverPageLazyWriteRateConfig) metricSqlserverPageLazyWriteRate {
...
type metricSqlserverPageLifeExpectancy struct {
	data          pmetric.Metric                    // data buffer for generated metric.
	config        SqlserverPageLifeExpectancyConfig // metric config provided by user.
	capacity      int                               // max observed number of data points added to the metric.
	aggDataPoints []int64                           // slice containing number of aggregated datapoints at each index
}
...
func (m *metricSqlserverPageLifeExpectancy) recordDataPoint(start pcommon.Timestamp, ts pcommon.Timestamp, val int64, performanceCounterObjectNameAttributeValue string) {
	...
	dp.SetStartTimestamp(start)
	dp.SetTimestamp(ts)
	if slices.Contains(m.config.EnabledAttributes, SqlserverPageLifeExpectancyAttributeKeyPerformanceCounterObjectName) {
...
func newMetricSqlserverPageLifeExpectancy(cfg SqlserverPageLifeExpectancyConfig) metricSqlserverPageLifeExpectancy {
...
type metricSqlserverPageLookupRate struct {
	data     pmetric.Metric                // data buffer for generated metric.
	config   SqlserverPageLookupRateConfig // metric config provided by user.
	capacity int                           // max observed number of data points added to the metric.
}
...
func newMetricSqlserverPageLookupRate(cfg SqlserverPageLookupRateConfig) metricSqlserverPageLookupRate {
...
type metricSqlserverPageOperationRate struct {
	data          pmetric.Metric                   // data buffer for generated metric.
	config        SqlserverPageOperationRateConfig // metric config provided by user.
	capacity      int                              // max observed number of data points added to the metric.
	aggDataPoints []float64                        // slice containing number of aggregated datapoints at each index
}
...
func (m *metricSqlserverPageOperationRate) recordDataPoint(start pcommon.Timestamp, ts pcommon.Timestamp, val float64, pageOperationsAttributeValue string) {
	...
	dp.SetStartTimestamp(start)
	dp.SetTimestamp(ts)
	if slices.Contains(m.config.EnabledAttributes, SqlserverPageOperationRateAttributeKeyPageOperations) {
...
func newMetricSqlserverPageOperationRate(cfg SqlserverPageOperationRateConfig) metricSqlserverPageOperationRate {
...
type metricSqlserverPageSplitRate struct {
	data     pmetric.Metric               // data buffer for generated metric.
	config   SqlserverPageSplitRateConfig // metric config provided by user.
	capacity int                          // max observed number of data points added to the metric.
}
...
func newMetricSqlserverPageSplitRate(cfg SqlserverPageSplitRateConfig) metricSqlserverPageSplitRate {
...
type metricSqlserverProcessesBlocked struct {
	data     pmetric.Metric                  // data buffer for generated metric.
	config   SqlserverProcessesBlockedConfig // metric config provided by user.
	capacity int                             // max observed number of data points added to the metric.
}
...
func newMetricSqlserverProcessesBlocked(cfg SqlserverProcessesBlockedConfig) metricSqlserverProcessesBlocked {
...
type metricSqlserverReplicaDataRate struct {
	data          pmetric.Metric                 // data buffer for generated metric.
	config        SqlserverReplicaDataRateConfig // metric config provided by user.
	capacity      int                            // max observed number of data points added to the metric.
	aggDataPoints []float64                      // slice containing number of aggregated datapoints at each index
}
...
func (m *metricSqlserverReplicaDataRate) recordDataPoint(start pcommon.Timestamp, ts pcommon.Timestamp, val float64, replicaDirectionAttributeValue string) {
	...
	dp.SetStartTimestamp(start)
	dp.SetTimestamp(ts)
	if slices.Contains(m.config.EnabledAttributes, SqlserverReplicaDataRateAttributeKeyReplicaDirection) {
...
func newMetricSqlserverReplicaDataRate(cfg SqlserverReplicaDataRateConfig) metricSqlserverReplicaDataRate {
...
type metricSqlserverResourcePoolDiskOperations struct {
	data          pmetric.Metric                            // data buffer for generated metric.
	config        SqlserverResourcePoolDiskOperationsConfig // metric config provided by user.
	capacity      int                                       // max observed number of data points added to the metric.
	aggDataPoints []float64                                 // slice containing number of aggregated datapoints at each index
}
...
func (m *metricSqlserverResourcePoolDiskOperations) recordDataPoint(start pcommon.Timestamp, ts pcommon.Timestamp, val float64, directionAttributeValue string) {
	...
	dp.SetStartTimestamp(start)
	dp.SetTimestamp(ts)
	if slices.Contains(m.config.EnabledAttributes, SqlserverResourcePoolDiskOperationsAttributeKeyDirection) {
		dp.Attributes().PutStr("direction", directionAttributeValue)
	}
...
func newMetricSqlserverResourcePoolDiskOperations(cfg SqlserverResourcePoolDiskOperationsConfig) metricSqlserverResourcePoolDiskOperations {
...
type metricSqlserverResourcePoolDiskThrottledReadRate struct {
	data     pmetric.Metric                                   // data buffer for generated metric.
	config   SqlserverResourcePoolDiskThrottledReadRateConfig // metric config provided by user.
	capacity int                                              // max observed number of data points added to the metric.
}
...
func newMetricSqlserverResourcePoolDiskThrottledReadRate(cfg SqlserverResourcePoolDiskThrottledReadRateConfig) metricSqlserverResourcePoolDiskThrottledReadRate {
...
type metricSqlserverResourcePoolDiskThrottledWriteRate struct {
	data     pmetric.Metric                                    // data buffer for generated metric.
	config   SqlserverResourcePoolDiskThrottledWriteRateConfig // metric config provided by user.
	capacity int                                               // max observed number of data points added to the metric.
}
...
func newMetricSqlserverResourcePoolDiskThrottledWriteRate(cfg SqlserverResourcePoolDiskThrottledWriteRateConfig) metricSqlserverResourcePoolDiskThrottledWriteRate {
...
type metricSqlserverTableCount struct {
	data          pmetric.Metric            // data buffer for generated metric.
	config        SqlserverTableCountConfig // metric config provided by user.
	capacity      int                       // max observed number of data points added to the metric.
	aggDataPoints []int64                   // slice containing number of aggregated datapoints at each index
}
...
func (m *metricSqlserverTableCount) recordDataPoint(start pcommon.Timestamp, ts pcommon.Timestamp, val int64, tableStateAttributeValue string, tableStatusAttributeValue string) {
	...
	dp.SetStartTimestamp(start)
	dp.SetTimestamp(ts)
	if slices.Contains(m.config.EnabledAttributes, SqlserverTableCountAttributeKeyTableState) {
		dp.Attributes().PutStr("table.state", tableStateAttributeValue)
	}
	if slices.Contains(m.config.EnabledAttributes, SqlserverTableCountAttributeKeyTableStatus) {
...
func newMetricSqlserverTableCount(cfg SqlserverTableCountConfig) metricSqlserverTableCount {
...
type metricSqlserverTransactionDelay struct {
	data     pmetric.Metric                  // data buffer for generated metric.
	config   SqlserverTransactionDelayConfig // metric config provided by user.
	capacity int                             // max observed number of data points added to the metric.
}
...
func newMetricSqlserverTransactionDelay(cfg SqlserverTransactionDelayConfig) metricSqlserverTransactionDelay {
...
type metricSqlserverTransactionMirrorWriteRate struct {
	data     pmetric.Metric                            // data buffer for generated metric.
	config   SqlserverTransactionMirrorWriteRateConfig // metric config provided by user.
	capacity int                                       // max observed number of data points added to the metric.
}
...
func newMetricSqlserverTransactionMirrorWriteRate(cfg SqlserverTransactionMirrorWriteRateConfig) metricSqlserverTransactionMirrorWriteRate {
...
type metricSqlserverTransactionRate struct {
	data     pmetric.Metric                 // data buffer for generated metric.
	config   SqlserverTransactionRateConfig // metric config provided by user.
	capacity int                            // max observed number of data points added to the metric.
}
...
func newMetricSqlserverTransactionRate(cfg SqlserverTransactionRateConfig) metricSqlserverTransactionRate {
...
type metricSqlserverTransactionWriteRate struct {
	data     pmetric.Metric                      // data buffer for generated metric.
	config   SqlserverTransactionWriteRateConfig // metric config provided by user.
	capacity int                                 // max observed number of data points added to the metric.
}
...
func newMetricSqlserverTransactionWriteRate(cfg SqlserverTransactionWriteRateConfig) metricSqlserverTransactionWriteRate {
...
type metricSqlserverTransactionLogFlushDataRate struct {
	data     pmetric.Metric                             // data buffer for generated metric.
	config   SqlserverTransactionLogFlushDataRateConfig // metric config provided by user.
	capacity int                                        // max observed number of data points added to the metric.
}
...
func newMetricSqlserverTransactionLogFlushDataRate(cfg SqlserverTransactionLogFlushDataRateConfig) metricSqlserverTransactionLogFlushDataRate {
...
type metricSqlserverTransactionLogFlushRate struct {
	data     pmetric.Metric                         // data buffer for generated metric.
	config   SqlserverTransactionLogFlushRateConfig // metric config provided by user.
	capacity int                                    // max observed number of data points added to the metric.
}
...
func newMetricSqlserverTransactionLogFlushRate(cfg SqlserverTransactionLogFlushRateConfig) metricSqlserverTransactionLogFlushRate {
...
type metricSqlserverTransactionLogFlushWaitRate struct {
	data     pmetric.Metric                             // data buffer for generated metric.
	config   SqlserverTransactionLogFlushWaitRateConfig // metric config provided by user.
	capacity int                                        // max observed number of data points added to the metric.
}
...
func newMetricSqlserverTransactionLogFlushWaitRate(cfg SqlserverTransactionLogFlushWaitRateConfig) metricSqlserverTransactionLogFlushWaitRate {
...
type metricSqlserverTransactionLogGrowthCount struct {
	data     pmetric.Metric                           // data buffer for generated metric.
	config   SqlserverTransactionLogGrowthCountConfig // metric config provided by user.
	capacity int                                      // max observed number of data points added to the metric.
}
...
func newMetricSqlserverTransactionLogGrowthCount(cfg SqlserverTransactionLogGrowthCountConfig) metricSqlserverTransactionLogGrowthCount {
...
type metricSqlserverTransactionLogShrinkCount struct {
	data     pmetric.Metric                           // data buffer for generated metric.
	config   SqlserverTransactionLogShrinkCountConfig // metric config provided by user.
	capacity int                                      // max observed number of data points added to the metric.
}
...
func newMetricSqlserverTransactionLogShrinkCount(cfg SqlserverTransactionLogShrinkCountConfig) metricSqlserverTransactionLogShrinkCount {
...
type metricSqlserverTransactionLogUsage struct {
	data     pmetric.Metric                     // data buffer for generated metric.
	config   SqlserverTransactionLogUsageConfig // metric config provided by user.
	capacity int                                // max observed number of data points added to the metric.
}
...
func newMetricSqlserverTransactionLogUsage(cfg SqlserverTransactionLogUsageConfig) metricSqlserverTransactionLogUsage {
...
type metricSqlserverUserConnectionCount struct {
	data     pmetric.Metric                     // data buffer for generated metric.
	config   SqlserverUserConnectionCountConfig // metric config provided by user.
	capacity int                                // max observed number of data points added to the metric.
}
...
func newMetricSqlserverUserConnectionCount(cfg SqlserverUserConnectionCountConfig) metricSqlserverUserConnectionCount {
